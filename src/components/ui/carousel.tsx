...
function CarouselPrevious({
  ...
  return (
    <Button
      ...
      {...props}
    >
      <IconChevronLeft className="-ms-0.5 size-6" />
...
function CarouselNext({
  ...
  return (
    <Button
      ...
      {...props}
    >
      <IconChevronRight className="ms-0.5 size-6" />
...
function CarouselThumbnail({
  ...
  return (
    <button
      ...
      className={cn(
        "rounded-box relative size-16 flex-shrink-0 overflow-hidden border-2 transition-all duration-200",
        isActive
