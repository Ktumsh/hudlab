export const formErrors = {
  ...
  invalid: {
    ...
    avatarInstance: "Debes proporcionar una imagen de avatar válida.",
    avatarFormat: "El formato de la imagen debe ser JPEG, PNG o WEBP.",
  },
  length: {
    ...
    bioMax: "La biografía no puede exceder los 150 caracteres",
